...
public class Aggregate extends Operator {
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        Type gbfieldType = this.gfield == -1 ? null : this.child.getTupleDesc().getFieldType(this.gfield);
    ...
    public void open() throws NoSuchElementException, DbException,
        ...
        if (this.agg != null) {
            ...
            this.resultIterator = this.agg.iterator();
    ...
    public TupleDesc getTupleDesc() {
        // some code goes here
        Type aggType = this.child.getTupleDesc().getFieldType(afield);
        String aggName = this.aop.toString() + "(" + this.child.getTupleDesc().getFieldName(afield) + ")";

        if(this.gfield == -1){
            return new TupleDesc(new Type[]{aggType}, new String[]{aggName});
        }else{
            Type groupType = this.child.getTupleDesc().getFieldType(gfield);
            String groupName = this.child.getTupleDesc().getFieldName(gfield);
